...
public class Questions1 {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Double> q3 = employeeList.stream()
                .collect(Collectors.groupingBy(Employee::getGender, Collectors.collectingAndThen(Collectors.averagingInt(Employee::getAge), Math::floor)));
        ...
        Map<String, Double> q7 = employeeList.stream()
                .collect(Collectors.groupingBy(Employee::getDepartment, Collectors.collectingAndThen(Collectors.averagingDouble(Employee::getSalary), Math::floor)));
        ...
        Map<String, Double> q11 = employeeList.stream()
                .collect(Collectors.groupingBy(Employee::getGender, Collectors.collectingAndThen(Collectors.averagingDouble(Employee::getSalary), Math::floor)));
        ...
        employeeList.stream()
                ...
                .forEach((condition, employees) -> {
                    if (condition)
                        ...
                        System.out.println("Employees older than 12 years - ");
                    employees.stream()
